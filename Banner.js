...
class Banner extends React.Component {
	...
	componentWillReceiveProps() {
		this.images = this.props.banners.map((banner) => banner.image);
		this.titles = this.props.banners.map((banner) => banner.title);
	}
	...
	render() {
		...
		return (
			<Swiper
				...
				loop={true}
				style={{ width: screenWidth, height: screenWidth / 1.9 }}
			>
				{imageViews}
			</Swiper>
		);
